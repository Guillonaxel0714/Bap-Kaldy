    ...
    <section style="margin-top: 10%; display: flex; justify-content: center;">
        <div class="panier">
            <div style="display: flex;">
                <p class="title-page">Panier :</p>
            </div>
            <div>
                <div>
                    <p style="font-family: 'Fira Sans', sans-serif; color:#3587A0; font-size: 150%;">Votre formation</p>
                </div>
                <div class="card mb-3">
                    <div class="row no-gutters" style="background-color: #EFEFEF;">
                        ...
                        <div class="col-md-8" style="display: flex;">
                            <div class="card-body" style="align-self: center;">
                                <h5 class="card-title"
                                    style="font-family: 'Fira Sans', sans-serif; color:#3587A0; font-size: 150%;">Coût
                                    de la formation :</h5>
                                <p class="card-text"
                                    style="font-family: 'Fira Sans', sans-serif; color:#175A75; font-size: 200%;">1200 €
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <div><a href="paiement.php"><button class="buttonforma" style="margin-top: 5%;">Acheter la
                            formation</button></a></div>
            </div>
