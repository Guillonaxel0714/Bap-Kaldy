...
if(isset($_POST['formconnexion']))
{
    ...
    if(!empty($mailconnect) AND !empty($mdpconnect))
    {
        ...
        {
          $erreur = "Le mail ou le mot de passe n'est pas correct";
        }
    ...
    <section style="margin-top: 15%; display: flex; justify-content: center;">
        <div class="panier">
            <div style="display: flex;">
                <p class="title-page">Connexion :</p>
            </div>
            <div>
                <form method="POST" action="">
                    <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label"
                            style="font-family: 'Fira Sans', sans-serif; color:#175A75; font-size: 100%;">Email</label>
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="inputEmail" name="mailconnect"
                                value="<?php if(isset($mailconnect)) { echo "$mailconnect"; } ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label"
                            style="font-family: 'Fira Sans', sans-serif; color:#175A75; font-size: 100%;">Mot de
                            passe</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="inputPassword" name="mdpconnect">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10">
