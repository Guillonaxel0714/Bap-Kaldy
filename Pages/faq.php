...
if(isset($_POST['formfaq'])){
  $contactnom = htmlspecialchars($_POST['contactnom']);
  $contactprenom = htmlspecialchars($_POST['contactprenom']);
  $contactmail = htmlspecialchars($_POST['contactmail']);
  $contactmessage = htmlspecialchars($_POST['contactmessage']);

  if(!empty($_POST['contactnom']) AND !empty($_POST['contactprenom']) AND !empty($_POST['contactmail']) AND !empty($_POST['contactmessage'])){

    $insertcontact = $bdd->prepare("INSERT INTO formulaire_contact(contactnom, contactprenom, contactmail, contactmessage) VALUES(?, ?, ?, ?)");
    $insertcontact->execute(array($contactnom, $contactprenom, $contactmail, $contactmessage));
    $_SESSION['messageenvoyé'] = "Votre message a été envoyé !";
    ...
    <section style="margin-top: 15%; display: flex; justify-content: center;">
        <div class="panier">
            <div style="display: flex;">
                <p style="font-family: 'Fira Sans', sans-serif; color:#175A75; font-size: 200%; margin-bottom: 1em;">Me
                    contacter :</p>
            </div>
            <div>
                <form action="" method="POST">
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label"
                            style="font-family: 'Fira Sans', sans-serif; color:#175A75; font-size: 100%;">Nom :</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label"
                            style="font-family: 'Fira Sans', sans-serif; color:#175A75; font-size: 100%;">Prénom
                            :</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="contactprenom">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label"
                            style="font-family: 'Fira Sans', sans-serif; color:#175A75; font-size: 100%;">Email
                            :</label>
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="inputEmail3" name="contactmail">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="validationTextarea"
                            style="font-family: 'Fira Sans', sans-serif; color:#175A75; font-size: 100%;">Votre message
                            :</label>
                        <textarea class="form-control" id="validationTextarea" name="contactmessage" placeholder=""
                            required></textarea>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button style="margin-top: 5%; margin-bottom: 15%;" type="submit" name="formfaq"
